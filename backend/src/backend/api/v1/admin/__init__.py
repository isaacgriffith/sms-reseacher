"""Administrative endpoints: health, jobs, providers, models, and agents (FR-045).
...
- ``/admin/providers/*`` — LLM provider CRUD (Feature 005).
- ``/admin/models/*`` — model enable/disable management (Feature 005).
- ``/admin/agents/*`` — agent CRUD and system-message generation (Feature 005).
...
# ---------------------------------------------------------------------------
# Feature 005: include sub-routers for providers, models, and agents.
